...
const CustomRadioButton = ({
  ...
  const renderOption = (option, index) => {
        ...
        <div key={optionValue} className={`relative ${optionClassName}`}>
          ...
          >
            <div className="flex items-center">
              <div
                className={`${currentSize.container} border-2 rounded-full mr-3 flex items-center justify-center
    ...
    return (
      <div
        key={optionValue}
        className={`relative flex items-center ${optionClassName}`}
      >
        <input
          type="radio"
          id={optionId}
        ...
        >
          <div
            className={`${currentSize.container} border-2 rounded-full mr-3 flex items-center justify-center transition-all duration-200
  ...
  return (
    <div className={`radio-group ${className}`} {...props}>
      {label && (
        <div
          className={`text-sm font-medium text-gray-700 mb-3 ${labelClassName}`}
        >
          {label}
      ...
      <div
        className={`${direction === "horizontal" ? "flex flex-wrap gap-3" : "space-y-3"}`}
      >
  ...
  const renderOption = (option, index) => {
    ...
    if (variant === "switch") {
      return (
        <div
          key={optionValue}
          className={`relative flex items-center justify-between ${optionClassName}`}
        >
          <span className="text-gray-700 font-medium">{optionLabel}</span>
          <input
            type="checkbox"
      ...
      return (
        <div key={optionValue} className={`relative ${optionClassName}`}>
          ...
          >
            <div className="flex items-center">
              <div
                className={`${currentSize} border-2 rounded mr-3 flex items-center justify-center
                ${isChecked ? "border-blue-500 bg-blue-500" : "border-gray-300"}`}
              >
                {isChecked && <CheckIcon />}
              </div>
    ...
    return (
      ...
      >
        ...
        >
          <div
            className={`${currentSize} border-2 rounded mr-3 flex items-center justify-center transition-all duration-200
            ${isChecked ? "border-blue-500 bg-blue-500" : "border-gray-300 hover:border-blue-400"}`}
          >
            {isChecked && <CheckIcon />}
          </div>
...
const CustomSingleCheckbox = ({
  ...
  const checkboxId =
    name || `checkbox-${Math.random().toString(36).substr(2, 9)}`;
    ...
    <div className="max-w-4xl mx-auto p-6 bg-gray-50 min-h-screen">
      ...
      <div className="mt-8 p-6 bg-white rounded-lg shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-600">
          <div>
            <p>
              <strong>Language:</strong> {selectedLanguage || "None"}
            </p>
            <p>
              <strong>Framework:</strong> {selectedFramework}
            </p>
            <p>
              <strong>Level:</strong> {selectedLevel || "None"}
            </p>
            <p>
              <strong>Colors:</strong> {selectedColors.join(", ") || "None"}
            </p>
          </div>
          <div>
            <p>
              <strong>Features:</strong> {selectedFeatures.join(", ") || "None"}
            </p>
            <p>
              <strong>Skills:</strong> {selectedSkills.join(", ") || "None"}
            </p>
            <p>
              <strong>Settings:</strong> {selectedSettings.join(", ") || "None"}
            </p>
            <p>
              <strong>Agreement:</strong> {agreed ? "Yes" : "No"}
            </p>
            <p>
