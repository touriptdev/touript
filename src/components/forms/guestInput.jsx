        ...
        >
          <div className="flex items-center">
            ...
            <div>
              ...
              <div className="text-xs text-gray-500">{getGuestSummary()}</div>
            </div>
          </div>
        ...
        {isOpen && (
          <div className="absolute z-10 mt-1 w-full bg-white shadow-lg rounded-lg border border-gray-200 py-2">
            {guestTypes.map((guestType, index) => (
              <div
                key={guestType.key}
                className={`px-4 py-3 ${index !== guestTypes.length - 1 ? "border-b border-gray-100" : ""}`}
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <button
                      onClick={() =>
                        updateGuestCount(guestType.key, "decrement")
                      }
                    ...
                    <button
                      onClick={() =>
                        updateGuestCount(guestType.key, "increment")
                      }
        ...
        <div className="space-y-2">
          {guestTypes.map((guestType) => (
            ...
            >
              ...
              <span
                className={`font-medium ${guests[guestType.key] > 0 ? "text-blue-600" : "text-gray-400"}`}
              >
                {guests[guestType.key]}
              </span>
            </div>
